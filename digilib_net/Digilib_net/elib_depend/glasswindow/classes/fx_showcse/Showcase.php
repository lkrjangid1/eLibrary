 ...
 */
function shwcse_prt($bin, $Infoarr, $folder, $ratio){
    echo'
<style>
.body-cont .Shwcse{
    position: relative;
...
.body-cont .Shwcse #Showcase-plane-1{
    opacity: 1;
    background: url(elib_depend/graphics/page_graphics/'.$folder.'/showcase/showcase_plane_1.jpg) center no-repeat;
...
for($i8=2 ; $i8<=$bin ; $i8++){
    ...
    .body-cont .Shwcse #Showcase-plane-'.$i8.'{
        opacity: 0;
        background: url(elib_depend/graphics/page_graphics/'.$folder.'/showcase/showcase_plane_'.$i8.'.jpg) center no-repeat;
        background-size: cover;
    }';
}
