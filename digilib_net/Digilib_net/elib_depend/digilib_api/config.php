...
//=============php confing						
    $db_CHARSET= "utf8";
    $db_htmlBASE = "http://".$_SERVER['HTTP_HOST']."/digilib_net/Digilib_net/";
    $developer_mode=0;		
    $prt_dev=0;
    define( '_Ds_' , '/');
    $UserLoginCookie = "digilib_std_cook";
    
//=============Mysql MACRO definations
	/*.mysqlhost*/$db_MYSQL_SERVER = 'localhost';
	/*.mysqluser*/$db_MYSQL_USER= 'root'; 					
	/*.mysqlpass*/$db_MYSQL_Pass= ''; 	
	/*.mysqldatabase*/$db_MYSQL_DB= "digilib_db";

//=============directories relative to index.php
//Dir
    /*+root Dir*/              $rootdir=         "/Applications/XAMPP/xamppfiles/htdocs/digilib_net/Digilib_net/";
//include
